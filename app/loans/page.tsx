...
import Loader from "../components/loans/Loader";
import LandingLayout from "../components/loans/LandingLayout";
import Header from "../components/loans/Header";
import BodyContent from "../components/loans/BodyContent";
