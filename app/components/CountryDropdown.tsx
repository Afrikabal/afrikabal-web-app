      ...
      <div className="absolute top-14 left-0 w-64 p-4 bg-white shadow-lg rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <ul className="space-y-2">
          {countries.map((country) => (
            ...
            >
              <div className="relative w-8 h-8 p-1 rounded-full flex items-center justify-center border border-solid transition-transform duration-300 hover:scale-110">
                <Image
                  src={country.flag}
