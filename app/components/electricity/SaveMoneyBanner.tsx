...
const faqs = [
    {
        question: "How do I recharge a prepaid meter on the Afrikabal app?",
        answer: (
            <>
    ...
    {
        question: "How do I make a postpaid meter payment on the Afrikabal app?",
        answer: (
            <>
                <p>To buy meter units on your Afrikabal app, follow these steps:</p>
                <ol className="list-decimal pl-6">
    ...
    {
        question: "Which electricity distribution companies can I buy meter tokens from on the Afrikabal app?",
        answer: (
            <>
    ...
    {
        question: "How do I load my meter token?",
        answer: (
            <>
    ...
    {
        question: "Why am I getting a 'Reject' error when I try to load a meter token?",
        answer: (
            <>
                <p>To buy meter units on your Afrikabal app, follow these steps:</p>
                <ol className="list-decimal pl-6">
    ...
    {
        question: "I'm getting a 'Link' error on my meter. What does this mean?",
        answer: (
            <>
                <p>To buy meter units on your Afrikabal app, follow these steps:</p>
                <ol className="list-decimal pl-6">
 ...
 function Faq() {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto py-10">
            <h2 className="text-3xl font-bold text-center mb-6 text-lime-600">Electricity Payments FAQs</h2>
