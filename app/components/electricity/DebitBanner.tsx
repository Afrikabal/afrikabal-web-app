...
import Debit from '@/images/buyE.jpg'
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-white py-10 px-24">
          ...
          <div className="max-w-lg text-center md:text-left">
              <h1 className="text-3xl md:text-5xl font-bold text-lime-600 mb-4">
                  Meter units finished <br /> at midnight? Buy <br /> more on the Kuda <br /> app.
              </h1>
              <p className="text-gray-600 mb-6">
                  Kuda takes the stress out of recharging your prepaid meter whenever you need to.
              </p>
