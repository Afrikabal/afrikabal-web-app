...
import Save from '@/images/free.jpg'
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-white py-10 px-24">
          ...
          <div className="max-w-lg text-center md:text-left">
              <h1 className="text-3xl md:text-5xl font-bold text-lime-600 mb-4">
                  Find all popular TV <br /> subscription <br /> packages.
              </h1>
              <p className="text-gray-600 mb-6">
                  Whether you have a favourite TV subscription package or you’re looking for the right one, the Kuda app makes it easy.
              </p>
