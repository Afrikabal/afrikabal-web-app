...
import { FaPaperPlane, FaTv} from 'react-icons/fa';
    ...
    const features = [
        {
            ...
            title: "Pay DStv, Showmax, GOtv and StarTimes subscriptions easily."
        },
        {
            icon: < FaPaperPlane />, 
            title: "Get your subscription token on the Kuda app or in your inbox."
        },
        {
            icon: <FaTv />, 
            title: "Never switch apps to make your TV payments again."
        },
