...
import Manage from '@/images/apps2.png'
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-white py-10 px-24">
          ...
          <div className="max-w-lg text-center md:text-left">
              <h1 className="text-xl md:text-5xl font-bold text-lime-600 mb-4">
                  Unlock apps, <br /> streaming <br /> platforms and <br /> games.
              </h1>
              <p className="text-gray-600 mb-6">
                  Increase your entertainment options with gift cards for Apple, iTunes, Play Store, Xbox, PlayStation and mobile games.
              </p>
