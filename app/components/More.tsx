      ...
      <div className="py-10 bg-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
              ...
              <div className="bg-white border rounded-lg shadow-lg p-6 text-center">
                  ...
                  <h3 className="text-xl font-semibold text-lime-600">Afrikabal Business</h3>
                  <p className="text-gray-600 mt-2">
                      Grow your business with our all-in-one business manager. Get a POS, bulk transfers, payroll, and more.
                  </p>
