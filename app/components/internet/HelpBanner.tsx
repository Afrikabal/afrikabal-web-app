...
const faqs = [
    {
        question: "What’s an internet data plan?",
        answer: (
            <>
    ...
    {
        question: "How much internet data do I need?",
        answer: (
            <>
    ...
    {
        question: "What consumes internet data?",
        answer: (
            <>
...
function Faq() {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto py-10">
            <h2 className="text-3xl font-bold text-center mb-6 text-lime-600">Internet Data FAQs</h2>
