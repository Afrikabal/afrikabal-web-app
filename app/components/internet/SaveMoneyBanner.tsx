...
import Save from '@/images/4g.jpg'
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-white py-10 px-24">
          ...
          <div className="max-w-lg text-center md:text-left">
              <h1 className="text-3xl md:text-5xl font-bold text-lime-600 mb-4">
                  Get monthly 4G and <br /> 5G data plans for <br /> modems and <br /> routers easily.
              </h1>
              <p className="text-gray-600 mb-6">
                  Subscribe to broadband internet for business and streaming any time.
              </p>
