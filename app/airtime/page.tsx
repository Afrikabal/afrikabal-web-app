...
import Loader from "../components/airtime/Loader";
import LandingLayout from "../components/airtime/LandingLayout";
import Header from "../components/airtime/Header";
import BodyContent from "../components/airtime/BodyContent";
import Footer from "../components/airtime/Footer";
import Image from "next/image";
import AppStore from '@/images/app_store.png'
import GooglePlay from '@/images/googleplay-removebg-preview.png'
import gif from '@/images/airtime.jpg'
        ...
        <LandingLayout>
            <div className='bg-white h-screen w-screen overflow-x-hidden text-black font-pacifico'>
                ...
                <BodyContent
                    ...
                    content='Buy Airtel, Glo, MTN and 9Mobile airtime and internet data any time.'
                    redirect={
                        <>
                            <a
